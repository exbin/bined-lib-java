...
/**
 * Example Lanterna GUI demonstration application of the bined component.
 *
...
public class BinEdExample {
    ...
    private static final String EXAMPLE_FILE_PATH = "/org/exbin/bined/lanterna/example/resources/lorem_1.txt";
