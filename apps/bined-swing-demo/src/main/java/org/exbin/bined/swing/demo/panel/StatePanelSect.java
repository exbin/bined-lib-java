...
import org.exbin.bined.swing.demo.BinEdDemoBasicPanel;
import org.exbin.bined.swing.section.SectCodeArea;
import org.exbin.auxiliary.binary_data.EditableBinaryData;
import org.exbin.bined.CodeAreaCaretPosition;
import org.exbin.bined.CodeAreaUtils;
import org.exbin.bined.EditMode;
import org.exbin.bined.swing.demo.BinEdDemo;
    ...
    private void saveDataButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveDataButtonActionPerformed
        ...
        if (saveFC.showSaveDialog(this) == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                Logger.getLogger(BinEdDemoBasicPanel.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private void testDataComboBoxItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_testDataComboBoxItemStateChanged
        ...
        if (selectedIndex > 0) {
            ...
            switch (selectedIndex) {
                case 1: {
                    switch (codeArea.getVerticalScrollUnit()) {
                        case PIXEL: {
                            ...
                            codeArea.setContentData(BinEdDemo.getBigSampleData(0, dataSize));
                            break;
                        }
                        case ROW: {
                ...
                case 3: {
                    codeArea.setContentData(BinEdDemo.getBigSampleData(0, Long.MAX_VALUE / 2));
                    break;
                }
                case 4: {
                    codeArea.setContentData(BinEdDemo.getBigSampleData(0, Long.MAX_VALUE - 1));
                    break;
                }
            }
