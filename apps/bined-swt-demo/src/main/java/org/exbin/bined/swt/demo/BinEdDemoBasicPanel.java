...
import org.exbin.bined.swt.demo.panel.CursorPanel;
import org.exbin.bined.swt.demo.panel.LayoutPanel;
import org.exbin.bined.swt.demo.panel.ModePanel;
import org.exbin.bined.swt.demo.panel.ScrollingPanel;
import org.exbin.bined.swt.demo.panel.StatePanel;
import org.exbin.bined.swt.demo.panel.ThemePanel;
...
public class BinEdDemoBasicPanel extends Composite {
    ...
    public BinEdDemoBasicPanel() {
        super(null, SWT.NULL);

        initComponents();
    }

    public BinEdDemoBasicPanel(Composite parent, int i) {
        super(parent, i);
