...
//            }
    ...
    private void paintCursorRect(@Nonnull Graphics g, int x, int y, int width, int height, @Nonnull CursorRenderingMode renderingMode, @Nonnull DefaultCodeAreaCaret caret) {
