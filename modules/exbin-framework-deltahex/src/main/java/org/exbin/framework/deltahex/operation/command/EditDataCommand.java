...
/**
 * Command for editing data.
 *
 * @version 0.1.0 2016/05/13
 * @author ExBin Project (http://exbin.org)
 */
public class EditDataCommand extends OpHexCommand {

    private final EditCommandType commandType;

    public EditDataCommand(Hexadecimal hexadecimal, EditCommandType commandType, long position, boolean positionLowerHalf) {
        super(hexadecimal);
    ...
    public void appendEdit(char value) {
        ((EditInsertDataOperation) operation).appendEdit(value);
    }
