...
import org.exbin.dhex.deltahex.HexStatusApi;
...
public class HexPanel extends javax.swing.JPanel implements XBEditorProvider, ClipboardActionsHandler, UndoActionsHandler {
    ...
    private void init() {
        ...
        hexadecimal.setData(new XBData());
...
//        }
    ...
    public XBLFormatDecl getContextFormatDecl() {
        ...
        XBPSerialReader reader = new XBPSerialReader(ClassLoader.class.getResourceAsStream("/org/exbin/dhex/deltahex/resources/xbt_format_decl.xb"));
